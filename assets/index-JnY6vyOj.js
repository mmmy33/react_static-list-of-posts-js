...
aut aut aut maxime quia temporibus ut omnis`}],Dc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Lc,{posts:Tc,users:Mc,comments:Rc})]});em(document.getElementById("root")).render(O.jsx(Dc,{}));
